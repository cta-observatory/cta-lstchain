...
#nfiles_gammas = 4#100*0.5 #Pointlike gammas
#nfiles_protons = 4#5000*0.8*0.5
nfiles_gammas = 4#100*0.5 #Pointlike gammas
nfiles_protons = 4#5000*0.8*0.5
...
print("nfiles_gammas, nfiles_protons ", nfiles_gammas, nfiles_protons)
...
print('gcut before', gcut)
print('tcut before', tcut)
#gcut = np.ones(eb) * 0.8
#tcut = np.ones(eb) * 0.01
print('gcut after', gcut)
print('tcut after', tcut)
