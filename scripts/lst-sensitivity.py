...
parser.add_argument('--gammadl2-cuts', '-gd2-train', type=str,
                    dest='dl2_file_g_cuts',
                    help='path to reconstructed gammas dl2 file')
parser.add_argument('--protondl2-cuts', '-pd2-train', type=str,
                    dest='dl2_file_p_cuts',
                    help='path to reconstructed protons dl2 file')
parser.add_argument('--gammadl2-sens', '-gd2-test', type=str,
                    dest='dl2_file_g_sens',
                    help='path to reconstructed gammas dl2 file')
parser.add_argument('--protondl2-sens', '-pd2-test', type=str,
