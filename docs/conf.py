# -*- coding: utf-8 -*-
#
# lstchain documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'lstchain.tex', u'lstchain Documentation',
     u'LST Collaboration', 'manual'),
]
...
man_pages = [
    (master_doc, 'lstchain', u'lstchain Documentation',
     [author], 1)
]
