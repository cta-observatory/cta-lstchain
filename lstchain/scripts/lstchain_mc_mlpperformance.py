...
"""
Pipeline to test train three Multi-layer Perceptron destinated to Energy, disp
reconstruction and to Gamma/Hadron separation and test the performance 
of the MLPClassifiers.

Inputs are DL1 files
Outputs are the  MLP trained models
...
from lstchain.reco import dl1_to_dl2_mod
...
def main():
    ...
    reg_energy, reg_disp_vector, cls_gh = dl1_to_dl2_mod.build_models(
        args.gammafile,
        args.protonfile,
    ...
    dl2 = dl1_to_dl2_mod.apply_models(data, cls_gh, reg_energy, reg_disp_vector, custom_config=config)
