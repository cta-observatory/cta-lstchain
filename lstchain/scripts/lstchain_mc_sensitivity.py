...
def main():
    ...
    energy, best_sens, result, units, gcut, tcut = sensitivity.find_best_cuts_sens(args.dl1file_gammas,
    ...
    energy, best_sens, result, units, dl2 = sensitivity.sens(args.dl1file_gammas,
                                               args.dl1file_protons,
