...
parser = argparse.ArgumentParser(
    description="Create DRS4 pedestal file",
...
required.add_argument(
    "-r", "--run_number", help="Run number with drs4 pedestals", type=int, required=True
)
optional.add_argument(
    "-v", "--prod_version", help="Version of the production", type=int, default=0
)
optional.add_argument(
    "-m",
    "--max_events",
...
def main():
    ...
    try:
        ...
        # run lstchain script
        cmd = (
            f"lstchain_data_create_drs4_pedestal_file "
