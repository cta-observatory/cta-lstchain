...
def apply_to_file(filename, models_dict, output_dir, config):
    ...
    try:
        ...
        logger.info("subarray table is not readable because of the version incompatibility.")
        logger.info("The effective focal length for the standard LST optics will be used.")
