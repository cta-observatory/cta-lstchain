...
def get_pointing_info(times, drive_report):
    ...
    try:
        ...
        valid = pointing_source.drive_report[1]['unix_time'] != 0
        pointing_source.drive_report[1] = pointing_source.drive_report[1][valid]
...
def merge_run_summary_with_pointing(run_summary, drive_report):
    ...
    # reorder columns
    table = table[['date', 'run_id', 'run_type', 'n_subruns', 'run_start', 'ra', 'dec', 'alt', 'az']]
    return table
...
def main():
    ...
    for run_summary in run_summaries:
        ...
        drive_report = drive_report_dir / f'drive_log_{night:%y_%m_%d}.txt'
