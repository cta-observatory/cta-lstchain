...
def test_create_event_list(simulated_dl2_file, simulated_irf_file):
    ...
    dl2_file_new = simulated_dl2_file.parent / simulated_dl2_file.name.replace(".h5","_new.h5")
    ...
    temp_hdulist = fits.HDUList([fits.PrimaryHDU(), evts, gti, pnt, aeff, edisp, bkg, psf])
