...
try:
    ...
    warnings.warn(
        "Could not determine lstchain version; this indicates a broken installation."
        " Install lstchain from PyPI, a local git repository or using "
        " pip install git+https://github.com/cta-observatory/lstchain@VERSION "
