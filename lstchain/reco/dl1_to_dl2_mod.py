...
def train_energy(train, custom_config={}):
    """
    Train a Multi-layer Regressor for the regression of the energy
    ...
    print("Training Multi-layer Perceptron Regressor for Energy Reconstruction...")
...
def train_disp_vector(train, custom_config={}, predict_features=['disp_dx', 'disp_dy']):
    """
    Train a model (MLPRegressor) for the regression of the disp_norm vector coordinates dx,dy.
...
def train_reco(train, custom_config={}):
    """
    Trains two MLP regressors for Energy and disp_norm
    ...
    print("Training Multi-layer Perceptron for disp_norm Reconstruction...")

    reg_disp = MLPRegressor(**regression_args)
...
def train_sep(train, custom_config={}):
    ...
    """Trains a Multi-layer Perceptron classifier for Gamma/Hadron separation.
    ...
    print("Given features: ", features)
    print("Number of events for training: ", train.shape[0])
    print("Training Multi-layer Perceptron Classifier for",
...
def build_models(filegammas, fileprotons,
    ...
    """Uses MC data to train Multi-layer Perceptrons for Energy and disp_norm
    reconstruction and G/H separation. Returns 3 trained MLP.
    ...
    regressor_energy: `MLPRegressor`
    regressor_disp: `MLPRegressor`
    classifier_gh: `MLPClassifier`
    """
