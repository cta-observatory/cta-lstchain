...
def plot_muon_event(
    ax, geom, image, centroid, ringrad_camcoord, ringrad_inner, ringrad_outer, event_id
):
    """
    ...
    disp0.add_ellipse(
        centroid, ringrad_camcoord.value, ringrad_camcoord.value, 0.0, 0.0, color="red"
    )
    disp0.add_ellipse(
        centroid, ringrad_inner.value, ringrad_inner.value, 0.0, 0.0, color="magenta"
    )
    disp0.add_ellipse(
        centroid, ringrad_outer.value, ringrad_outer.value, 0.0, 0.0, color="magenta"
    )
